      ...
      <div className="relative">
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 min-w-full bg-black bg-opacity-50 md:bg-gradient-to-r md:from-white md:to-white/10 md:rounded-3xl self-center pl-4 md:pl-0">
          <div className="flex flex-col items-start justify-center md:w-2/6 h-full">
            <span className="text-[#F3BC4C] text-sm md:text-lg lg:text-xl">
              TECH SERVICES
            </span>
            <h1 className="text-white md:text-black text-5xl lg:text-6xl font-semibold md:font-medium md:leading-20 mt-4">
              TechSynergy:
              <br /> Innovate, Create, Elevate
            </h1>
            <p className="text-white md:text-black text-sm md:text-base lg:text-lg font-medium my-6 md:my-4 xl:my-10">
